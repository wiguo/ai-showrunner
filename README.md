...
## 🎬 [▶ Watch the demo video](https://vimeo.com/1206942432)

[![Once Upon a Line — live scene grid](docs/demo-scene-grid.png)](https://vimeo.com/1206942432)

*One sentence in — "a baby wakes up in her cot and must choose whom to call" —
and the agent scripted, storyboarded, filmed, voiced and subtitled a branching
film, live on Alibaba Cloud. Every frame below was generated by the agent.*

| | |
|---|---|
| ![Generated keyframe](docs/demo-game-frame.png) *A frame from the generated film (wan t2i → happyhorse i2v)* | ![In-game choice](docs/demo-game-choice.png) *The playable choice — each option leads to a different scene* |
| ![Story composer](docs/demo-composer.png) *The composer — jobs are resumable, errors surface with one-click resume* | ![Game start](docs/demo-game-start.png) *The finished Ren'Py game's start gate* |

### 🍿 Films made by Once Upon a Line

Full playthroughs of games the agent produced — three genres, same one-sentence input each time:

- **[▶ Static Tomorrow](https://vimeo.com/1206950343)** — supernatural thriller: a night-shift radio host's only caller is herself, calling from tomorrow *(9 scenes, 2 branch points)*
- **[▶ Same Pay, Different Pain](https://vimeo.com/1206950581)** — workplace comedy: data engineer vs data scientist, pick your poison *(13 scenes, branching career paths)*
